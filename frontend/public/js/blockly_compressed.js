...
goog.string.compareVersions = function (a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            ...
            var c = 0 == h[1].length ? 0 : parseInt(h[1], 10), l = 0 == k[1].length ? 0 : parseInt(k[1], 10),
    ...
    if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
        ...
        if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
            if (!goog.events.isMarkedIeEvent_(d)) {
                ...
                for (g = 0; !e.propagationStopped_ && g < d.length; g++) e.currentTarget = d[g], h = goog.events.fireListeners_(d[g], c, !1, e), f = f && h
            }
    ...
    if (a) {
        ...
        if (c) {
            ...
            if (d < b.length) {
                ...
                for (var g = c.rows[0].cells.length; d < b.length;) {
                    var h = b[d++];
...
goog.structs.Map.prototype.cleanupKeysArray_ = function () {
    ...
    if (this.count_ != this.keys_.length) {
        var d = {};
        for (a = b = 0; b < this.keys_.length;) c = this.keys_[b], goog.structs.Map.hasKey_(d, c) || (this.keys_[a++] = c, d[c] = 1), b++;
        this.keys_.length = a
    }
};
...
goog.structs.Map.prototype.addAll = function (a) {
    if (a instanceof goog.structs.Map) {
        var b = a.getKeys();
        a = a.getValues()
    } else b = goog.object.getKeys(a), a = goog.object.getValues(a);
...
Blockly.onMouseUp_ = function (a) {
    ...
    a.dragMode_ != Blockly.DRAG_NONE && (Blockly.Touch.clearTouchIdentifier(), a.resetDragSurface(), a.dragMode_ = Blockly.DRAG_NONE, Blockly.Touch.onTouchUpWrapper_ && (Blockly.unbindEvent_(Blockly.Touch.onTouchUpWrapper_), Blockly.Touch.onTouchUpWrapper_ = null), Blockly.onMouseMoveWrapper_ && (Blockly.unbindEvent_(Blockly.onMouseMoveWrapper_), Blockly.onMouseMoveWrapper_ = null))
};
...
Blockly.Workspace.prototype.renameVariable = function (a, b) {
    var c, d = this.variableIndexOf(a), e = this.variableIndexOf(b);
    -1 != e && this.variableList[e] != b && (c = this.variableList[e]);
    Blockly.Events.setGroup(!0);
    for (var f = this.getAllBlocks(), g = 0; g < f.length; g++) f[g].renameVar(a, b), c && f[g].renameVar(c, b);
    Blockly.Events.setGroup(!1);
    d == e || -1 != d && -1 == e ? this.variableList[d] = b : -1 != d && -1 != e ? (this.variableList[e] = b, this.variableList.splice(d, 1)) : (this.variableList.push(b), console.log("Tried to rename an non-existent variable."))
};
...
Blockly.Workspace.prototype.deleteVariable = function (a) {
    if (-1 != this.variableIndexOf(a)) {
        ...
        var e = this;
        1 < b.length ? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace("%1", b.length).replace("%2", a), function (b) {
            b && e.deleteVariableInternal_(a)
        }) : this.deleteVariableInternal_(a)
    }
};
Blockly.Workspace.prototype.deleteVariableInternal_ = function (a) {
    var b = this.getVariableUses(a);
    a = this.variableIndexOf(a);
    Blockly.Events.setGroup(!0);
    for (var c = 0; c < b.length; c++) b[c].dispose(!0, !1);
    Blockly.Events.setGroup(!1);
    this.variableList.splice(a, 1)
};
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), l = Math.cos(h), n = this.getBubbleSize(),
            h = (n.width + n.height) / Blockly.Bubble.ARROW_THICKNESS, h = Math.min(h, n.width, n.height) / 4,
            n = 1 - Blockly.Bubble.ANCHOR_RADIUS / f, d = b +
                n * d, e = c + n * e, n = b + h * l, m = c + h * k, b = b - h * l, c = c - h * k,
...
Blockly.Connection.prototype.connect_ = function (a) {
    ...
    var l;
    Blockly.Events.isEnabled() && (l = new Blockly.Events.Move(d));
...
Blockly.Extensions.apply = function (a, b, c) {
    ...
    e.apply(b);
    if (c) Blockly.Extensions.checkBlockHasMutatorProperties_(a, b, 'Error after applying mutator "' + a + '": '); else if (!Blockly.Extensions.mutatorPropertiesMatch_(d, b)) throw Error('Error when applying extension "' + a + '": mutation properties changed when applying a non-mutator extension.');
};
Blockly.Extensions.checkHasFunction_ = function (a, b, c) {
    if (!b.hasOwnProperty(c)) throw Error(a + 'missing required property "' + c + '"');
    if ("function" !== typeof b[c]) throw Error(a + '" required property "' + c + '" must be a function');
};
...
Blockly.Extensions.checkMutatorDialog_ = function (a, b) {
    var c = a.hasOwnProperty("compose"), d = a.hasOwnProperty("decompose");
    if (c && d) {
...
Blockly.Field.prototype.init = function () {
    this.fieldGroup_ || (this.fieldGroup_ = Blockly.utils.createSvgElement("g", {}, null), this.visible_ || (this.fieldGroup_.style.display = "none"), this.borderRect_ = Blockly.utils.createSvgElement("rect", {
        ...
        this.mouseUpWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mouseup", this, this.onMouseUp_), this.render_())
};
...
Blockly.Field.prototype.onMouseUp_ = function (a) {
    if (!goog.userAgent.IPHONE && !goog.userAgent.IPAD || goog.userAgent.isVersionOrHigher("537.51.2") || 0 === a.layerX || 0 === a.layerY) Blockly.utils.isRightButton(a) || this.sourceBlock_.workspace.isDragging() || this.sourceBlock_.isEditable() && this.showEditor_()
};
...
Blockly.Options = function (a) {
    ...
    m = "end" === m ? !1 : !0;
    var q = n ? m ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM :
        m == l ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT;
    var p = a.scrollbars;
    void 0 === p && (p = f);
    var t = a.css;
    void 0 === t && (t = !0);
    ...
    m = void 0 === a.oneBasedIndex ? !0 : !!a.oneBasedIndex;
    this.RTL = l;
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function (a) {
    ...
    if (Blockly.utils.isRightButton(a)) a.stopPropagation(); else {
        var b = Blockly.utils.mouseToSvg(a, this.workspace_.getParentSvg(), this.workspace_.getInverseScreenCTM()),
            b = this.horizontal_ ? b.x : b.y, c = Blockly.utils.getInjectionDivXY_(this.svgHandle_),
            c = this.horizontal_ ? c.x : c.y, d = this.handlePosition_, e = .95 * this.handleLength_;
...
Blockly.Trashcan.prototype.createDom = function () {
    ...
    var a = String(Math.random()).substring(2),
        b = Blockly.utils.createSvgElement("clipPath", {id: "blocklyTrashBodyClipPath" + a}, this.svgGroup_);
...
Blockly.Xml.blockToDom = function (a, b) {
    ...
    for (var e = 0, f; f = a.inputList[e]; e++) {
        var g = 0;
        for (var h; h = f.fieldRow[g]; g++) if (h.name && h.EDITABLE) {
            var k = goog.dom.createDom("field", null, h.getValue());
            k.setAttribute("name", h.name);
            d.appendChild(k)
        }
    }
    if (e = a.getCommentText()) e = goog.dom.createDom("comment",
        null, e), "object" == typeof a.comment && (e.setAttribute("pinned", a.comment.isVisible()), f = a.comment.getBubbleSize(), e.setAttribute("h", f.height), e.setAttribute("w", f.width)), d.appendChild(e);
    a.data && (e = goog.dom.createDom("data", null, a.data), d.appendChild(e));
    for (e = 0; f = a.inputList[e]; e++) h = !0, f.type != Blockly.DUMMY_INPUT && (k = f.connection.targetBlock(), f.type == Blockly.INPUT_VALUE ? c = goog.dom.createDom("value") : f.type == Blockly.NEXT_STATEMENT && (c = goog.dom.createDom("statement")), g = f.connection.getShadowDom(),
    !g || k && k.isShadow() || c.appendChild(Blockly.Xml.cloneShadow_(g)), k && (c.appendChild(Blockly.Xml.blockToDom(k, b)), h = !1), c.setAttribute("name", f.name), h || d.appendChild(c));
...
Blockly.Xml.domToWorkspace = function (a, b) {
    ...
    for (var g = 0; g < e; g++) {
        var h = a.childNodes[g], k = h.nodeName.toLowerCase();
        if ("block" == k || "shadow" == k && !Blockly.Events.recordUndo) {
            k = Blockly.Xml.domToBlock(h,
                b);
            c.push(k.id);
            var l = parseInt(h.getAttribute("x"), 10), h = parseInt(h.getAttribute("y"), 10);
            isNaN(l) || isNaN(h) || k.moveBy(b.RTL ? d - l : l, h)
        } else "shadow" == k && goog.asserts.fail("Shadow block cannot be a top-level block.")
    }
...
Blockly.ZoomControls.prototype.createDom = function () {
    ...
    var b = String(Math.random()).substring(2),
        c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomoutClipPath" + b}, this.svgGroup_);
...
Blockly.Workspace.prototype.otraceOn = function (a) {
    this.traceOn_ = a;
    this.traceWrapper_ && (Blockly.unbindEvent_(this.traceWrapper_), this.traceWrapper_ = null);
    a && (this.traceWrapper_ = Blockly.bindEvent_(this.svgBlockCanvas_, "blocklySelectChange", this, function () {
        this.traceOn_ = !1
...
Blockly.Workspace.prototype.ohighlightBlock = function (a) {
    if (this.traceOn_) {
        var b = null;
...
Blockly.WorkspaceSvg.prototype.paste = function (a) {
    if (this.rendered && !(a.getElementsByTagName("block").length >= this.remainingCapacity())) {
        ...
        try {
            ...
            var c = parseInt(a.getAttribute("x"), 10), d = parseInt(a.getAttribute("y"), 10);
            if (!isNaN(c) && !isNaN(d)) {
                this.RTL && (c = -c);
                do {
                    var e = !1;
                    var f = this.getAllBlocks();
                    a = 0;
                    for (var g; g = f[a]; a++) {
                    ...
                    if (!e) {
                        var k =
                            b.getConnections_(!1);
                        a = 0;
                        for (var l; l = k[a]; a++) if (l.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d)).connection) {
                            e = !0;
                            break
                        }
                    }
                    e && (c = this.RTL ? c - Blockly.SNAP_RADIUS : c + Blockly.SNAP_RADIUS, d += 2 * Blockly.SNAP_RADIUS)
                } while (e);
                b.moveBy(c, d)
            }
        } finally {
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function (a) {
    ...
    return this.deleteAreaTrash_ && this.deleteAreaTrash_.contains(a) ? Blockly.DELETE_AREA_TRASH : this.deleteAreaToolbox_ && this.deleteAreaToolbox_.contains(a) ? Blockly.DELETE_AREA_TOOLBOX : null
};
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function (a) {
    ...
    Blockly.utils.isTargetInput(a) ? Blockly.Touch.clearTouchIdentifier() : (Blockly.terminateDrag_(), Blockly.hideChaff(), a.target && a.target.nodeName && ("svg" == a.target.nodeName.toLowerCase() || a.target == this.svgBackground_) && Blockly.selected && !this.options.readOnly && Blockly.selected.unselect(), Blockly.utils.isRightButton(a) ? (this.showContextMenu_(a), Blockly.onMouseUp_(a), Blockly.Touch.clearTouchIdentifier()) : this.scrollbar ? (this.dragMode_ =
        ...
        [], Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_.concat(Blockly.bindEventWithChecks_(document, "mousemove", null, Blockly.onMouseMove_))) : Blockly.Touch.clearTouchIdentifier(), a.stopPropagation(), a.preventDefault())
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        var d = [], e = this.getTopBlocks(!0), f = Blockly.utils.genUid(), g = {};
        ...
        if (this.options.collapse) {
            for (var h = g = !1, k = 0; k < e.length; k++) for (var l = e[k]; l;) l.isCollapsed() ? g = !0 : h = !0, l = l.getNextBlock();
            var n = function (a) {
...
Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_ = function (a) {
    ...
    this.options.gridPattern && (this.options.gridPattern.setAttribute("x", a), this.options.gridPattern.setAttribute("y",
        b), (goog.userAgent.IE || goog.userAgent.EDGE) && this.updateGridPattern_())
};
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
    ...
    goog.asserts.assert(f == b.length, 'block "%s": Message does not reference all %s arg(s).', this.type, b.length);
    a.length && ("string" == typeof a[a.length -
    1] || goog.string.startsWith(a[a.length - 1].type, "field_")) && (g = {type: "input_dummy"}, c && (g.align = c), a.push(g));
    ...
    for (g = 0; g < a.length; g++) if (f = a[g], "string" == typeof f) b.push([f, void 0]); else {
        d = h = null;
        do if (e = !1, "string" == typeof f) h = new Blockly.FieldLabel(f); else switch (f.type) {
            case "input_value":
...
Blockly.Block.newFieldTextInputFromJson_ = function (a) {
    var b = Blockly.utils.replaceMessageReferences(a.text), b = new Blockly.FieldTextInput(b, a["class"]);
...
Blockly.BlockSvg = function (a, b, c) {
    ...
    this.rendered = !1;
    this.useDragSurface_ = Blockly.utils.is3dSupported() &&
        !!a.blockDragSurface_;
...
Blockly.BlockSvg.prototype.onMouseDown_ = function (a) {
    if (!this.workspace.options.readOnly) if (this.isInFlyout) "touchstart" == a.type && Blockly.utils.isRightButton(a) && (Blockly.Flyout.blockRightClick_(a, this), a.stopPropagation(), a.preventDefault()); else {
        ...
        this.select();
        Blockly.hideChaff();
        if (Blockly.utils.isRightButton(a)) this.showContextMenu_(a), Blockly.Touch.clearTouchIdentifier();
...
Blockly.BlockSvg.prototype.onMouseUp_ = function (a) {
    Blockly.Touch.clearTouchIdentifier();
    Blockly.dragMode_ == Blockly.DRAG_FREE || Blockly.WidgetDiv.isVisible() || (this.bringToFront_(), Blockly.Events.fire(new Blockly.Events.Ui(this, "click", void 0, void 0)));
    Blockly.terminateDrag_();
    a = this.workspace.isDeleteArea(a);
    Blockly.selected && Blockly.highlightedConnection_ && a != Blockly.DELETE_AREA_TOOLBOX ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.rendered && (Blockly.localConnection_.isSuperior() ?
        Blockly.highlightedConnection_ : Blockly.localConnection_).getSourceBlock().connectionUiEffect(), this.workspace.trashcan && this.workspace.trashcan.close()) : a && !this.getParent() && Blockly.selected.isDeletable() && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), this.workspace.toolbox_ && this.workspace.toolbox_.removeDeleteStyle(), Blockly.selected.dispose(!1, !0));
...
Blockly.BlockSvg.prototype.onMouseMove_ = function (a) {
    if ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation(); else {
        ...
        if (Blockly.dragMode_ == Blockly.DRAG_STICKY && goog.math.Coordinate.distance(b, c) * this.workspace.scale > Blockly.DRAG_RADIUS) {
            ...
            var d = !!this.parentBlock_;
            var e = !Blockly.DRAG_STACK;
            if (a.altKey || a.ctrlKey || a.metaKey) e =
                !e;
            this.unplug(e);
            d && (d = this.getSvgRoot(), d.translate_ = "translate(" + c.x + "," + c.y + ")", this.disconnectUiEffect());
            this.setDragging_(!0);
        ...
        if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
            ...
            d = this.getSvgRoot();
            this.useDragSurface_ ? this.workspace.blockDragSurface_.translateSurface(c.x, c.y) : (d.translate_ = "translate(" + c.x + "," + c.y + ")", d.setAttribute("transform", d.translate_ + d.skew_));
            ...
            for (var f = e = null, g = Blockly.SNAP_RADIUS, c = 0; c < d.length; c++) {
            ...
            !this.updateCursor_(a, e) && e && e != Blockly.highlightedConnection_ &&
            (e.highlight(), Blockly.highlightedConnection_ = e, Blockly.localConnection_ = f)
        }
        a.stopPropagation();
        a.preventDefault()
    }
};
Blockly.BlockSvg.prototype.updateCursor_ = function (a, b) {
    var c = this.workspace.isDeleteArea(a), d = Blockly.selected && b && c != Blockly.DELETE_AREA_TOOLBOX;
    if (c && !this.getParent() && Blockly.selected.isDeletable() && !d) return Blockly.utils.addClass(this.svgGroup_, "blocklyDraggingDelete"), this.workspace.toolbox_ && this.workspace.toolbox_.addDeleteStyle(), c == Blockly.DELETE_AREA_TRASH && this.workspace.trashcan && this.workspace.trashcan.setOpen_(!0), !0;
    this.workspace.trashcan && this.workspace.trashcan.setOpen_(!1);
    Blockly.utils.removeClass(this.svgGroup_,
        "blocklyDraggingDelete");
    this.workspace.toolbox_ && this.workspace.toolbox_.removeDeleteStyle();
    return !1
};
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), n = 0, m; m = b[n]; n++) if (m.isVisible()) {
        if (l && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT) var q = c[c.length - 1]; else k = m.type, q = [], q.type = l &&
        ...
        for (var p = !1, t = 0, r; r = m.fieldRow[t]; t++) {
            0 != t && (m.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X);
            var u = r.getSize();
            r.renderWidth = u.width;
            r.renderSep = p && r.EDITABLE ? Blockly.BlockSvg.SEP_SPACE_X : 0;
    ...
    for (a = 0; q = c[a]; a++) if (q.thicker = !1, q.type == Blockly.BlockSvg.INLINE) for (b = 0; m = q[b]; b++) if (m.type == Blockly.INPUT_VALUE) {
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f) {
    for (var g, h, k, l, n = 0, m, q = 0, p; p = e[q]; q++) {
        ...
        } else p.type == Blockly.INPUT_VALUE ? (l = p[0], k = h, h = n, l.align != Blockly.ALIGN_LEFT && (g = e.rightEdge - l.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, l.align == Blockly.ALIGN_RIGHT ? k += g : l.align == Blockly.ALIGN_CENTRE && (k += g / 2)), this.renderFields_(l.fieldRow, k, h), a.push(Blockly.BlockSvg.TAB_PATH_DOWN), g = p.height - Blockly.BlockSvg.TAB_HEIGHT, a.push("v", g), this.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),
            b.push("v", g + .5)) : (b.push("M", e.rightEdge - 5 + "," + (n + Blockly.BlockSvg.TAB_HEIGHT - .7)), b.push("l", .46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")), k = this.RTL ? -e.rightEdge - 1 : e.rightEdge + 1, l.connection.setOffsetInBlock(k, n), l.connection.isConnected() && (this.width = Math.max(this.width, e.rightEdge + l.connection.targetBlock().getHeightWidth().width - Blockly.BlockSvg.TAB_WIDTH + 1))) : p.type == Blockly.DUMMY_INPUT ? (l = p[0], k = h, h = n, l.align != Blockly.ALIGN_LEFT && (g = e.rightEdge - l.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, e.hasValue &&
        (g -= Blockly.BlockSvg.TAB_WIDTH), l.align == Blockly.ALIGN_RIGHT ? k += g : l.align == Blockly.ALIGN_CENTRE && (k += g / 2)), this.renderFields_(l.fieldRow, k, h), a.push("v", p.height), this.RTL && b.push("v", p.height - 1)) : p.type == Blockly.NEXT_STATEMENT && (l = p[0], 0 == q && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), n += Blockly.BlockSvg.SEP_SPACE_Y), k = h, h = n, l.align != Blockly.ALIGN_LEFT && (g = e.statementEdge - l.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, l.align == Blockly.ALIGN_RIGHT ? k +=
            g : l.align == Blockly.ALIGN_CENTRE && (k += g / 2)), this.renderFields_(l.fieldRow, k, h), h = e.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", h), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", e.rightEdge), this.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (n + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL),
            b.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (n + p.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR)), b.push("H", e.rightEdge - .5), k = this.RTL ? -h : h + 1, l.connection.setOffsetInBlock(k, n + 1), l.connection.isConnected() && (this.width = Math.max(this.width, e.statementEdge + l.connection.targetBlock().getHeightWidth().width)),
        q == e.length - 1 || e[q + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), n += Blockly.BlockSvg.SEP_SPACE_Y);
        n += p.height
    }
    e.length || (n = Blockly.BlockSvg.MIN_BLOCK_Y, a.push("V", n), this.RTL && b.push("V", n - 1));
    return n
};
...
Blockly.FieldTextInput.prototype.setText = function (a) {
    null !== a && (a = String(a), a !== this.text_ && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, "field", this.name, this.text_, a)), Blockly.Field.prototype.setText.call(this, a)))
};
...
Blockly.FieldTextInput.prototype.showEditor_ = function (a) {
    ...
    if (!a && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD)) {
        ...
        var c = Blockly.WidgetDiv.DIV, d = goog.dom.createDom("INPUT", "blocklyHtmlInput");
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
    ...
    if (a.firstChild) {
        ...
        }, a), b = Blockly.utils.createSvgElement("circle",
            {
        ...
        if (!(b || 2 > a.length)) {
            ...
            if ((b || d) && !(c <= b + d)) {
                ...
                for (c = 0; c < a.length; c++) {
                    var f = a[c][0], g = a[c][1], f = f.substring(b, f.length - d);
                    e[c] = [f, g]
                }
    ...
    function b(a, b) {
        for (var d = 0; d < a.length; d++) {
            ...
            for (e = 0; e < f.length; e++) {
                var q = goog.dom.createDom("arg");
                q.setAttribute("name", f[e]);
                m.appendChild(q)
            }
            c.push(g)
        }
...
Blockly.FlyoutButton.prototype.createDom = function () {
    ...
    this.svgGroup_ = Blockly.utils.createSvgElement("g", {"class": b}, this.workspace_.getCanvas());
    ...
    var b = Blockly.utils.createSvgElement("rect", {
        ...
        rx: 4, ry: 4
    }, this.svgGroup_), c = Blockly.utils.createSvgElement("text", {
...
Blockly.Flyout.prototype.position = function () {
    if (this.isVisible()) {
        ...
        if (a) {
            ...
            Blockly.utils.setCssTransform(this.svgGroup_, "translate(" + b + "px," + c + "px)");
            this.scrollbar_ && (this.scrollbar_.setOrigin(b, c), this.scrollbar_.resize())
        }
    }
};
...
Blockly.Flyout.prototype.layout_ = function (a, b) {
    ...
    } else "button" == f.type && (f = f.button, g = f.createDom(), f.moveTo(d, c), f.show(), Blockly.bindEventWithChecks_(g, "mouseup", f, f.onMouseUp), this.buttons_.push(f), this.horizontalLayout_ ? d += f.width + b[e] :
        c += f.height + b[e])
};
...
Blockly.Flyout.prototype.isDragTowardWorkspace_ = function (a, b) {
    var c = Math.atan2(b, a) / Math.PI * 180, d = this.dragAngleRange_;
    if (this.horizontalLayout_) {
...
Blockly.Flyout.prototype.createBlockFunc_ = function (a) {
    ...
    return function (c) {
        if (!Blockly.utils.isRightButton(c) && !a.disabled) {
            ...
            if (goog.userAgent.IE || goog.userAgent.EDGE) for (var e = d.getDescendants(), f = e.length - 1; 0 <= f; f--) e[f].render(!1);
            d.onMouseDown_(c);
            Blockly.dragMode_ = Blockly.DRAG_FREE;
            d.setDragging_(!0);
...
Blockly.Flyout.prototype.placeNewBlock_ = function (a) {
    ...
    (d = b.getMetrics().viewHeight - this.height_, e = b.scale, c.y += d / e - d);
...
Blockly.Toolbox.prototype.position = function () {
    var a = this.HtmlDiv;
    if (a) {
        var b = this.workspace_.getParentSvg(), b = Blockly.svgSize(b);
...
Blockly.inject = function (a, b) {
    ...
    var e = Blockly.createDom_(d, c), f = new Blockly.BlockDragSurfaceSvg(d),
        d = new Blockly.WorkspaceDragSurfaceSvg(d), c = Blockly.createMainWorkspace_(e, c, f, d);
    Blockly.init_(c);
...
Blockly.createDom_ = function (a, b) {
    ...
    d = Blockly.utils.createSvgElement("pattern", {id: "blocklyGridPattern" + e, patternUnits: "userSpaceOnUse"},
        d);
    0 < b.gridOptions.length && 0 < b.gridOptions.spacing && (Blockly.utils.createSvgElement("line", {stroke: b.gridOptions.colour}, d), 1 < b.gridOptions.length && Blockly.utils.createSvgElement("line", {stroke: b.gridOptions.colour}, d));
    b.gridPattern = d;
    return c
};
Blockly.createMainWorkspace_ = function (a, b, c, d) {
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function () {
        if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
            ...
            if (a.contentTop <
                d || a.contentTop + a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft : c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c)) for (var k = e.getTopBlocks(!1), l = 0, n; n = k[l]; l++) {
                var m = n.getRelativeToSurfaceXY(), q = n.getHeightWidth(), p = d + 25 - q.height - m.y;
                0 < p && n.moveBy(0, p);
                p = d + a.viewHeight - 25 - m.y;
                0 > p && n.moveBy(0, p);
                p = 25 + c - m.x - (b.RTL ? 0 : q.width);
                0 < p && n.moveBy(p, 0);
                m = c + a.viewWidth - 25 - m.x + (b.RTL ? q.width : 0);
                0 > m && n.moveBy(m, 0)
            }
        }
    });
...
Blockly.onKeyDown_ = function (a) {
    if (!Blockly.mainWorkspace.options.readOnly && !Blockly.utils.isTargetInput(a)) {
        var b = !1;
        if (27 == a.keyCode) Blockly.hideChaff(); else if (8 == a.keyCode || 46 == a.keyCode) a.preventDefault(), Blockly.selected && Blockly.selected.isDeletable() && (b = !0); else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected),
            b = !0)), 86 == a.keyCode ? Blockly.clipboardXml_ && (Blockly.Events.setGroup(!0), Blockly.clipboardSource_.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1)) : 90 == a.keyCode && (Blockly.hideChaff(), Blockly.mainWorkspace.undo(a.shiftKey));
...
Blockly.bindEventWithChecks_ = function (a, b, c, d, e) {
    ...
    if (b in Blockly.Touch.TOUCH_MAP) for (var k = function (a) {
        g(a);
        f && a.preventDefault()
    }, l = 0, n; n = Blockly.Touch.TOUCH_MAP[b][l]; l++) a.addEventListener(n, k, !1), h.push([a, n, k]);
    return h
};
