...
Blockly.defineBlocksWithJsonArray(
    [
        ...
        {
            "type": "Set_CScript_Mode",
            "lastDummyAlign0": "CENTRE",
            "message0": "以 %1 方式运行C程序",
            "args0": [
                {
                    "type": "field_dropdown",
                    "name": "mode",
            ...
            "args0": [
                {
                    "type": "field_input",
                    "name": "CODE",
                    "text": "forward(5,12);gpp_say(1,\"立即执行程序\");void main(){}"
                }
            ],
            "previousStatement": null,
            "nextStatement": null,
...
Blockly.Blocks.procedures_callnoreturn = {
    init: function () {
        ...
        if (this.workspace &&
            !this.workspace.isFlyout) if (a.type == Blockly.Events.CREATE && -1 != a.ids.indexOf(this.id)) {
